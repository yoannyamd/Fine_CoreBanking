...
from app.core.exceptions import (
    ...
    AccountNotFoundError, AccountingBaseError,
)
...
async def create_account(
    ...
    """Crée un nouveau compte dans le plan de comptes."""
    try:
...
async def list_accounts(
    ...
    """Liste les comptes avec filtres et pagination."""
...
async def get_account_balance(
    ...
    """Retourne le solde d'un compte sur une période."""
    try:
